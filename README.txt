...
Netlify Dağıtım Durumu
=======================
[![Netlify Status](https://api.netlify.com/api/v1/badges/f7e170ff-42d0-4971-ab40-9784b46ba986/deploy-status?branch=main)](https://app.netlify.com/sites/dynamic-pudding-7a8c17/deploys)

Bu rozet, projenizin en son dağıtım durumunu yansıtacak şekilde otomatik olarak güncellenir.
